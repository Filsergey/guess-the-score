...
async def mini_app():
 ...
 scripts=(
  ...
  '<script src="/static/app-shell.js?v=30"></script>'
  '<script src="/static/achievement-notify.js?v=10" data-gts-achievement-notify="1"></script>'
  ...
  '<script src="/static/match-detail-live-sync.js?v=2"></script>'

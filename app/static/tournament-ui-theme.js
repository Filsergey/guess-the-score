...
const PALETTES={
  ...
  140:{name:'laliga',accent:'#ff4655',accent2:'#ff4655',rgb:'255,70,85',bg1:'#ffffff',bg2:'#f5f5f3',panel:'#ffffff',text:'#111111',muted:'#626262'},
...
html[data-gts-tournament-theme='laliga'] body{background:#fff!important;color:#111!important}
html[data-gts-tournament-theme='laliga'] .top{background:#fff!important;border-color:#ff4655!important;box-shadow:0 5px 18px rgba(255,70,85,.16)!important}
html[data-gts-tournament-theme='laliga'] .select,
html[data-gts-tournament-theme='laliga'] .selector-copy strong,
html[data-gts-tournament-theme='laliga'] .selector-chevron,
html[data-gts-tournament-theme='laliga'] .top .profile-rank strong{color:#111!important}
html[data-gts-tournament-theme='laliga'] .selector-copy small,
html[data-gts-tournament-theme='laliga'] .top .profile-rank small{color:#ff4655!important}
html[data-gts-tournament-theme='laliga'] .top .profile{border-left-color:#e4e4e4!important}
html[data-gts-tournament-theme='laliga'] .nav{background:#fff!important;border-top:1px solid #e5e5e5!important;box-shadow:0 -8px 24px rgba(0,0,0,.06)!important}
html[data-gts-tournament-theme='laliga'] .nav button,
html[data-gts-tournament-theme='laliga'] .nav a{color:#5c5c5c!important}
html[data-gts-tournament-theme='laliga'] .nav .active,
html[data-gts-tournament-theme='laliga'] .nav [aria-current='page']{color:#ff4655!important;text-shadow:none!important}
html[data-gts-tournament-theme='laliga'] h1,
html[data-gts-tournament-theme='laliga'] h2,
html[data-gts-tournament-theme='laliga'] h3,
html[data-gts-tournament-theme='laliga'] .section-head h2,
html[data-gts-tournament-theme='laliga'] .leagues-page-head h1,
html[data-gts-tournament-theme='laliga'] .league-section-label,
html[data-gts-tournament-theme='laliga'] .tournament-title{color:#111!important;text-shadow:none!important}
html[data-gts-tournament-theme='laliga'] .muted,
html[data-gts-tournament-theme='laliga'] .match .muted{color:#666!important}
html[data-gts-tournament-theme='laliga'] .tournament,
html[data-gts-tournament-theme='laliga'] .match,
html[data-gts-tournament-theme='laliga'] .sheet,
html[data-gts-tournament-theme='laliga'] .modal,
html[data-gts-tournament-theme='laliga'] .menu-card,
html[data-gts-tournament-theme='laliga'] .panel{background:#fff!important;color:#111!important;border-color:#dedede!important;box-shadow:0 8px 24px rgba(0,0,0,.06)!important}
html[data-gts-tournament-theme='laliga'] .tournament{background-image:linear-gradient(135deg,#fff 0%,#f8f8f6 65%,#fff1f2 100%)!important}
...
html[data-gts-tournament-theme='laliga'] .pill,
html[data-gts-tournament-theme='laliga'] .primary,
html[data-gts-tournament-theme='laliga'] .btn-primary{background:#ff4655!important;color:#fff!important;border-color:#ff4655!important}
html[data-gts-tournament-theme='laliga'] .secondary,
html[data-gts-tournament-theme='laliga'] .btn-secondary,
html[data-gts-tournament-theme='laliga'] .league-bottom-actions button{background:#fff!important;color:#111!important;border-color:#cfcfcf!important}
html[data-gts-tournament-theme='laliga'] input,
html[data-gts-tournament-theme='laliga'] select,
html[data-gts-tournament-theme='laliga'] textarea{background:#fff!important;color:#111!important;border-color:#d7d7d7!important}
...
html[data-gts-tournament-theme='laliga'] #view-home,
html[data-gts-tournament-theme='laliga'] #view-matches,
html[data-gts-tournament-theme='laliga'] #view-leagues,
html[data-gts-tournament-theme='laliga'] #view-table,
html[data-gts-tournament-theme='laliga'] #view-menu{color:#111!important}
`;

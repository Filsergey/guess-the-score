...
style.textContent=`
#leaguesView .league-card.has-delete{padding-right:142px}
#leaguesView .league-edit{position:absolute;right:77px;top:50%;transform:translateY(-50%);height:31px;padding:0 10px;border-radius:10px;display:flex;align-items:center;justify-content:center;color:#9fd3ff;background:rgba(25,88,137,.18);border:1px solid rgba(63,143,203,.34);font-size:9px;font-weight:850;z-index:3;white-space:nowrap}
#leaguesView .league-edit:active{background:rgba(35,111,171,.28)}
@media(max-width:430px){#leaguesView .league-card.has-delete{padding-right:132px}#leaguesView .league-edit{right:73px;padding:0 8px;font-size:8.5px}}
`;

...
async def player_photo_proxy(src: str = Query(min_length=8, max_length=1200)):
    """Generic HTTPS image proxy kept only for backwards compatibility.

    Current player photos are served from /api/players/{id}/photo and sourced
    from UEFA. This route no longer resolves players through external providers.
    """
